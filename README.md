...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&pause=1200&color=512BD4&center=true&vCenter=true&width=680&lines=Software+Engineer;.NET+%2F+ASP.NET+Core+Backend+Developer;AWS+Serverless+%26+DevOps+Practitioner;I+ship+systems+end-to-end" alt="Software Engineer — .NET, AWS, DevOps" />

# Hi, I'm Mohamed Hussein Al-Adawy 👋
...
<img src="https://komarev.com/ghpvc/?username=moheladwy&style=flat-square&color=512BD4" alt="Profile views">
...
![Dapper](https://img.shields.io/badge/Dapper-A8B9CC?style=flat-square&logo=databricks&logoColor=black)
...
![Serilog](https://img.shields.io/badge/Serilog-1F425F?style=flat-square&logo=serverfault&logoColor=white)
...
| --- | --- | --- |
| **[OCR4Linux](https://github.com/moheladwy/OCR4Linux)** ⭐ 80 | CLI tool that extracts text from screenshots on Linux — works on both X11 and Wayland | `Bash` `Python` `Tesseract` |
| **[ExpertBridge](https://github.com/moheladwy/ExpertBridge)** ⭐ 4 | Graduation project (4.0/4.0) — professional network connecting users with experts: personalized feeds, hiring, chat, AI content moderation, dual-role reputation | `ASP.NET Core 9` `React TS` `PostgreSQL` `pgvector` `Groq` `Docker` |
...
**Software Engineer** · RocketDevs *(US, Remote)* — Apr 2025 – Present
> Own the integration platform end-to-end: idempotent, fault-tolerant webhook flows on AWS Lambda; observability standards for the lambda fleet; an event-driven paid-media analytics pipeline on EventBridge. Lead maintainer and primary reviewer — gatekeep all merges to `master`.
...
🥇 **1st Place — Orange Egypt AI Hackathon** (Feb 2025) · 100,000 EGP
...
🎓 **B.Sc. Computer Science** — Faculty of Computers & AI, Cairo University (2021–2025) · Graduation project: **4.0/4.0**

🧩 **300+ problems solved** across Codeforces, LeetCode, and UVA

<a href="https://codeforces.com/profile/wolfwar"><img src="https://img.shields.io/badge/Codeforces-1F8ACB?style=flat-square&logo=codeforces&logoColor=white" alt="Codeforces"></a>
<a href="https://leetcode.com/mohamed_h_eladwy/"><img src="https://img.shields.io/badge/LeetCode-FFA116?style=flat-square&logo=leetcode&logoColor=black" alt="LeetCode"></a>
<a href="https://www.hackerrank.com/EladwyMohamed"><img src="https://img.shields.io/badge/HackerRank-00EA64?style=flat-square&logo=hackerrank&logoColor=black" alt="HackerRank"></a>
...
**[mohamed.h.eladwy@gmail.com](mailto:mohamed.h.eladwy@gmail.com)** — open to backend, .NET, and cloud/DevOps roles.

<sub>Fluent in Arabic and English 🇪🇬 🇬🇧</sub>
